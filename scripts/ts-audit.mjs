...
const ALLOWED_JS = new Set([
  ...
  "src/theSaver-lib/flow-enforcer.js", // compiled from src/theSaver-lib/flow-enforcer.ts
  "src/theSaver-lib/session-metrics.js", // compiled from src/theSaver-lib/session-metrics.ts
