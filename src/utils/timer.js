...
export function elapsedNew(startTime) {
...
export function formatDuration(arg) {
    ...
    if (typeof arg === 'number') {
        ...
        const parts = arg ?? {};
        hours = Number.isFinite(parts.hours) ? parts.hours : 0;
        minutes = Number.isFinite(parts.minutes) ? parts.minutes : 0;
        seconds = Number.isFinite(parts.seconds) ? parts.seconds : 0;
    }
