...
test("blackbox smoke: resolveOptimizationMode — ML drives, explicit modes respected only in fallback", () => {
  ...
  assert.equal(turn.resolveOptimizationMode("DIVERGENT", 0.1, "auto"), "vibelitex")
