...
const SITUATION_TYPES = ["work", "relationship", "opportunity", "health", "financial"] as const
...
const ACTION_MAP: Record<string, { high_exposure: string[]; low_exposure: string[]; default: string }> = {
  work: {
...
export function classifySituation(text: string): string {
...
export function getActions(situationType: string, exposure: ExposureLevel): string[] {
...
export function recommendAction(state: DecisionState): ActionCategory {
...
export function getSituationTypes(): string[] {
