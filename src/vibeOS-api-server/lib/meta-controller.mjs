...
export type OptimizationMode = "balanced" | "budget" | "quality" | "speed" | "longrun" | "auto"
...
type RegimeControlMap = Record<string, Omit<ControlVector, "directives" | "enforcement_reason" | "optimization_mode"> & { enforcement_reason: string }>
...
export function autoSelectMode(subRegime: string, stressMultiplier?: number): OptimizationMode {
  ...
  if (stressMultiplier && stressMultiplier > 0.5) return "quality"
  return "budget"
}
