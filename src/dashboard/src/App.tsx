...
import { openSSE, fetchStatus, fetchSavings, type StatusPayload, type SavingsPayload } from "./api"
...
type Tab = "status" | "controls" | "reports" | "blackbox"
    ...
    <div class="app">
      <header class="header">
        ...
        <div class="header-indicators">
          <span class={`indicator ${conn() ? "connected" : "disconnected"}`}>
      ...
      <main class="content">
        ...
        {tab() === "controls" && (
          <Controls
            status={s()}
            onAction={() => {
              fetchStatus().then(setS)
              fetchSavings().then(setSv)
            }}
          />
        )}
